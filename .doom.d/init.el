...
(doom! :input
       ...
       (cc +lsp +treesitter)           ; C/C++/Obj-C madness
       ;;clojure           ; java with a lisp
       ;;common-lisp       ; if you've seen one lisp, you've seen them all
       ;;coq               ; proofs-as-programs
       ;;crystal           ; ruby at the speed of c
       (csharp +lsp +unity +dotnet +tree-sitter)       ; unity, .NET, and mono shenanigans
       ...
       ;;scala             ; java, but good
       (scheme +guile +chicken +gambit)   ; a fully conniving family of lisps
